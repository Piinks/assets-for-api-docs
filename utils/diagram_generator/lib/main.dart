...
Future<Null> main() async {
  ...
  final List<DiagramStep> steps = <DiagramStep>[
    ...
    new DropdownButtonDiagramStep(controller),
    new FlatButtonDiagramStep(controller),
    new FloatingActionButtonDiagramStep(controller),
    new HeroesDiagramStep(controller),
    new IconButtonDiagramStep(controller),
